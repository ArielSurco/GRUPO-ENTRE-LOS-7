...
const AboutUs = () => {
  ...
  return (
    <>
      ...
      <Box
        data-aos="flip-left" data-aos-duration="3000" data-aos-delay="500"
        component="img"
        sx={{
          height: 233,
          width: 350,
        ...
        <div data-aos="fade-up" data-aos-duration="2000"data-aos-delay="500" className="ContenedorNosotrosH1">
        <Box
        component="h1"
        sx={{
