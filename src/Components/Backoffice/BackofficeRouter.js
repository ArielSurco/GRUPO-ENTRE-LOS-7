    ...
    <>
      ...
      <Router>
        ...
        >
          ...
          <PrivateRoute path={`${path}/activities/edit/:activityId`} component={ActivitiesForm} />
          <PrivateRoute path={`${path}/testimonials/edit/:testimonialId`} component={TestimonialForm} />
          ...
          <PrivateRoute path={`${path}/testimonials/create`} component={TestimonialForm} />
          <PrivateRoute path={`${path}/users/create`} component={UserForm} />
          <PrivateRoute path={`${path}/members/create`} component={MembersForm} />
          <PrivateRoute path={`${path}/projects/create`} component={ProjectsForm} />
          <PrivateRoute path={`${path}/slides/create`} component={SlidesForm} />
          <PrivateRoute path={`${path}/home`} component={EditHomeForm} />
          <PrivateRoute path={`${path}/members`} component={MembersResults} />
          <PrivateRoute path={`${path}/users`} component={BackofficeUsers} />
          <PrivateRoute path={`${path}/categories`} component={CategoriesList} />
          <PrivateRoute path={`${path}/activities`} component={ActivitiesTable} />
